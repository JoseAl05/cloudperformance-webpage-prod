...
// const ComparisonCell = ({ row, tenantIds }: { row: AggregatedComputeRow, tenantIds: string[] }) => {
...
//                         if (tenantCost === 0 && !row.max_resource_name[tid]) return null;

//                         const maxResName = row.max_resource_name[tid];
//                         const maxResCost = row.max_resource_cost[tid];
//                         const minResName = row.min_resource_name[tid];
//                         const minResCost = row.min_resource_cost[tid];
...
// export const getIntraCloudComputeBillingColumns = (
//     allData: IntraCloudComputeBilling[]
