...
interface IntraCloudServiceSelectionComponentProps {
    cloudType: string;
    onServiceSelected: (service: ServiceType) => void;
}

export const IntraCloudServiceSelectionComponent = ({ cloudType, onServiceSelected }: IntraCloudServiceSelectionComponentProps) => {
