...
import { CostosVsPresupuestoChart } from "@/components/aws/presupuesto/costo-vs-presupuesto/graficos/CostosVsPresupuestoViewSummaryComponent";
import ComparacionMensualTableComponent from "@/components/aws/presupuesto/costo-vs-presupuesto/table/ComparacionMensualTableComponent";
...
export const CostosVsPresupuestoComponent = ({ anio, cloud, centroDeCosto }: CentroDeCostoComponentProps) => {
