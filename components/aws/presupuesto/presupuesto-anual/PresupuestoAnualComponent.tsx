...
import { PresupuestoAnualTableComponent } from "@/components/aws/presupuesto/presupuesto-anual/table/PresupuestoAnualTableComponent";
import { PresupuestoAnualFormComponent, PresupuestoAnual } from "@/components/aws/presupuesto/presupuesto-anual/form/PresupuestoAnualFormComponent";
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">
                  Presupuestos Anuales {cloudType}
                </h1>
          ...
          <DialogContent className="!max-w-none w-[70vw] h-[90vh] overflow-y-auto p-8 rounded-2xl shadow-xl">
            <DialogHeader>
              <DialogTitle className="text-gray-900 dark:text-gray-100">
                {editingPresupuesto ? `Editar Presupuesto Anual ${cloudType}` : `Nuevo Presupuesto Anual ${cloudType}`}
              </DialogTitle>
