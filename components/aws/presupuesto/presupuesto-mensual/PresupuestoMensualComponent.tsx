...
import { PresupuestoMensualTableComponent } from "@/components/aws/presupuesto/presupuesto-mensual/table/PresupuestoMensualTableComponent";
import {
  PresupuestoMensualFormComponent,
  PresupuestoMensual,
} from "@/components/aws/presupuesto/presupuesto-mensual/form/PresupuestoMensualFormComponent";
        ...
        <div className="mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">
                  Presupuestos Mensual {cloudType}
                </h1>
                <p className="text-gray-500 dark:text-gray-400">
                  Gestión de presupuestos mensuales 📊
                </p>
          ...
          <DialogContent className="!max-w-none w-[35vw] ">
            <DialogHeader>
              <DialogTitle className="text-gray-900 dark:text-gray-100">
                {editingItem
                  ? `Editar Presupuesto Mensual (${cloudType})`
                  : `Nuevo Presupuesto Mensual (${cloudType})`}
              </DialogTitle>
