...
// Función para determinar el grupo de una métrica RDS MySQL
...
// Función para formatear valores según el tipo de métrica RDS MySQL
...
const getColorByAbsoluteValue = (
  ...
  console.log(`MYSQL MÉTRICA: ${metricLabel}, VALOR: ${value}, POSICIÓN: ${position}, TOTAL: ${totalValues}, VALORES: [${values.join(', ')}]`);
    ...
    <div className="bg-white dark:bg-transparent rounded-lg shadow-lg p-6 border border-gray-200 dark:border-slate-700">
      ...
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-2">
          Uso por Región - Heatmap RDS MySQL
        </h2>
        <p className="text-gray-600">
          Visualización de métricas promedio por región AWS - Instancias RDS MySQL
        </p>
      </div>
          ...
          {data.map((item) => (
            <div key={item.region} className="flex border-b border-gray-100 hover:bg-gray-50/50 transition-colors duration-150">
              ...
              {allMetrics.map((metric) => {
                ...
                console.log('MYSQL DEBUG COLOR - metric:', metric, 'value:', value);                
