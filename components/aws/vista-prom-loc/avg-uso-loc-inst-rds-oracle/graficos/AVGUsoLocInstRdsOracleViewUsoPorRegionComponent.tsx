...
const getColorByAbsoluteValue = (
  ...
  console.log(`ORACLE MÉTRICA: ${metricLabel}, VALOR: ${value}, POSICIÓN: ${position}, TOTAL: ${totalValues}, VALORES: [${values.join(', ')}]`);
          ...
          {data.map((item) => (
            <div key={item.region} className="flex border-b border-gray-100 hover:bg-gray-50/50 transition-colors duration-150">
              ...
              {allMetrics.map((metric) => {
                ...
                console.log('ORACLE DEBUG COLOR - metric:', metric, 'value:', value);                
