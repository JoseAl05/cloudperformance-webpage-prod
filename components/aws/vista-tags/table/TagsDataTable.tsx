...
export const TagsDataTableAWS = ({ data }: TagsDataTableProps) => {
    ...
    const columns = useMemo<ColumnDef<typeof flattenedData[0]>[]>(() => [
        ...
        },
        {
            ...
            cell: (info) => <span className="text-xs font-mono text-gray-600">{info.getValue() as string}</span>
        },
        {
                ...
                return (
                    <div className="flex flex-wrap gap-1.5 max-w-[450px]">
                        {Object.entries(tags).map(([k, v]) => {
                            ...
                            return (
                                <div key={k} className={`inline-flex items-center rounded border text-[10px] shadow-sm overflow-hidden ${isLocal ? 'border-purple-200' : 'border-[#FF9900]/30'}`}>
                                    <span className={`px-1.5 py-0.5 font-medium border-r flex items-center gap-1 ${isLocal ? 'bg-purple-50 text-purple-700 border-purple-200' : 'bg-[#FF9900]/10 text-[#FF9900] border-[#FF9900]/30'}`}>
                        ...
                        <div className="p-5 space-y-4">
                            ...
                            <div className="bg-amber-50 p-3 rounded-lg border border-amber-100 flex gap-2">
                                ...
                                <p className="text-[10px] text-amber-700 leading-relaxed">
                                    Nota: Si la llave ya existe, el valor se actualizará. Los cambios son locales y no afectan la consola de AWS.
                                </p>
                            </div>
                        </div>
