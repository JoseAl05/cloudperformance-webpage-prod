...
const METRIC_CONFIG: Record<string, { label: string; unit: string; formatType: 'percent' | 'bytes' | 'count' }> = {
    ...
    networkin: { label: 'Red: Tráfico Entrante', unit: 'B/s', formatType: 'bytes' },
    networkout: { label: 'Red: Tráfico Saliente', unit: 'B/s', formatType: 'bytes' },
    statuscheckfailed: { label: 'Check de Estado Fallido', unit: 'Fallos', formatType: 'count' },
};
...
interface Ec2InstancesConsumeChartComponentProps {
    data: ConsumeViewEc2Metrics[] | null;
}

export const Ec2InstancesConsumeChartComponent = ({ data }: Ec2InstancesConsumeChartComponentProps) => {
