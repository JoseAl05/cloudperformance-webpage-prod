...
import { AlertCircle, ChartBar, Info, Loader2 } from 'lucide-react';
...
export const AsgConsumeComponent = ({ startDate, endDate, instance, region }: AsgConsumeComponentProps) => {
    ...
    return (
        <div className="w-full min-w-0 px-4 py-6">
            {hasInfoData && hasCpuData && (
                <div className="flex-1 space-y-6 min-w-0 overflow-hidden">
                    <Ec2InfoConsumeViewComponent
                        cpuData={cpuMetricsData}
                        creditsData={creditsMetricsData /* puede ser null, el hijo no la usa directamente */}
                        infoData={infoData}
            ...
            <div className="flex flex-col gap-5 mt-10">
                ...
                {hasCreditsData && <Ec2ResourceConsumeViewUsageCreditsComponent data={creditsMetricsData} />}
                {hasCpuData && <Ec2ResourceConsumeViewUsageCpuComponent data={cpuMetricsData} />}
            </div>
            {hasInfoData && (
