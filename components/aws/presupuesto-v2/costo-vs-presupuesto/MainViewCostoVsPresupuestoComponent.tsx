...
import { CostosVsPresupuestoComponentAWS } from "./CostosVsPresupuestoComponent";

export const MainViewCostoVsPresupuestoAws = () => {
  return (
    <SessionGate>
      <div className="w-full min-w-0 space-y-4">
        ...
        <div className="w-full min-w-0">
          <FiltersComponent
            Component={CostosVsPresupuestoComponentAWS}
            dateFilter={false}
            anioFilter 
            cloudFilterType={"aws"}
          />
