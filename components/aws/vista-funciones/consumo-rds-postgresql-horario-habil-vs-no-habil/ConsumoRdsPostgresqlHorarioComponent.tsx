...
export const MainViewConsumoRdsPostgresqlHorario = ({ startDate, endDate, metric }: ConsumoEC2HorarioProps) => {
  ...
  const { data, error, isLoading } = useSWR(
    `${process.env.NEXT_PUBLIC_API_URL}/aws/rds/postgresql/business-vs-offhours?date_from=${startDateFormatted}&date_to=${endDateFormatted}&metric_label=${metric}`,
    fetcher
  )
