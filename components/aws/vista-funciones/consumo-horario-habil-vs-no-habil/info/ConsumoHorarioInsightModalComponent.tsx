...
export const ConsumoHorarioInfoView = ({ data }: { data: WorkingNonWorkingHoursUsageSummaryByResource }) => {
    return (
...
export const ConsumoHorarioMetricsView = ({ data }: { data: WorkingNonWorkingHoursUsageSummaryByResource }) => {
...
export const ConsumoHorarioAnalysisView = ({ data }: { data: WorkingNonWorkingHoursUsageSummaryByResource }) => {

    const analyzeResource = () => {
        const cpuW = getVal(data.metric_data, 'cpuutilization', 'business_hours');
        const cpuNW = getVal(data.metric_data, 'cpuutilization', 'non_business_hours');
