...
type TableDataTopResource = {
  ...
  end_date: string
  dimension: string // ahora representa RESOURCE_ID
...
export const TableComponentTop = ({
  ...
  // 🔎 Filtrar fuera los valores con 0 (ambos neto y bruto deben ser distintos de 0)
    ...
    <Card>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <CardTitle className="flex items-center gap-2">
              🆔 Historial de facturación por Recurso
            </CardTitle>
            <p className="text-sm text-muted-foreground mt-1">
              Detalle de facturación de servicios agrupados por recurso
            </p>
          </div>
        </div>
      </CardHeader>
      ...
      <CardContent>
        <DataTableGrouping
          ...
          groupByColumn="service_dimension"     // agrupa por recurso
        />
