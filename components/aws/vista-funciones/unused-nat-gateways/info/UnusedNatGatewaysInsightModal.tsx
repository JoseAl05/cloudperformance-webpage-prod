...
export const UnusedNatGatewaysInsightModal = ({ natGw, asociatedResources, isLoading, isOpen, onClose }: UnusedNatGatewaysInsightModalProps) => {
                                    ...
                                    <div className="p-6 grid gap-6">
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            ...
                                            <div className="p-4 border rounded-lg bg-slate-50 dark:bg-slate-900/50">
                                                ...
                                                <p className="text-2xl font-bold">{bytesToMB(metrics.total_bytes_out)} MB</p>
                                            </div>
                                        </div>
                                                    ...
                                                    <div className="flex-1 border rounded-lg p-4 text-sm hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors">
                                                        ...
                                                        <div className="grid grid-cols-2 gap-4">
                                                            <div className="p-4 border rounded-lg bg-slate-50 dark:bg-slate-900/50">
                                                                <div className="flex items-center gap-2 mb-2 text-muted-foreground">
                                                                    <Activity className="h-4 w-4" />
                                                                    <p className="text-xs font-medium">Conexiones Promedio</p>
                                                                </div>
                                                                <p className="text-sm font-bold">{detail.metrics_summary.avg_active_connections.toFixed(2)}</p>
                                                            </div>
                                                            <div className="p-4 border rounded-lg bg-slate-50 dark:bg-slate-900/50">
                                                                <div className="flex items-center gap-2 mb-2 text-muted-foreground">
                                                                    <ArrowRightLeft className="h-4 w-4" />
                                                                    <p className="text-xs font-medium">Tráfico Saliente (Total)</p>
                                                                </div>
                                                                <p className="text-sm font-bold">{bytesToMB(detail.metrics_summary.total_bytes_out)} MB</p>
                                                            </div>
                                                        </div>
