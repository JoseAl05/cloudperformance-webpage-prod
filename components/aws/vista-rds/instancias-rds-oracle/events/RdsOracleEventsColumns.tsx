...
const RdsOracleEventDetailsModal = ({ event }: { event: RdsOracleEvent }) => {
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className='max-w-4xl'>
                <DialogHeader>
                    ...
                    <DialogDescription>Información completa sobre el evento de RDS Oracle</DialogDescription>
                </DialogHeader>
...
export const rdsOracleEventColumns: ColumnDef<RdsOracleEvent>[] = [
    {
            ...
            return (
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align='end'>
                        ...
                        <RdsOracleEventDetailsModal event={row.original} />
                    </DropdownMenuContent>
                </DropdownMenu>
            )
        },
