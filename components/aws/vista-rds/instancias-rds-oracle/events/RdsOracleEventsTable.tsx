...
import { rdsOracleEventColumns } from '@/components/aws/vista-rds/instancias-rds-oracle/events/RdsOracleEventsColumns';
...
interface RdsOracleEventsTableComponentProps {
    data?: unknown;
    startDate: Date;
    endDate: Date;
    instance: string;
...
export const RdsOracleEventsTableComponent = ({
    data,
    startDate,
    endDate,
    instance,
    isLoading = false
}: RdsOracleEventsTableComponentProps) => {
    const eventsColumns = createColumns(rdsOracleEventColumns);
                ...
                <div className='flex flex-col md:flex-row justify-between items-start md:items-center gap-4'>
                    <div>
                        <CardTitle className='flex items-center gap-2'>
                            ...
                            Historial de Eventos RDS Oracle
                        </CardTitle>
            ...
            <CardContent>
                {isLoading ? (
                    <div className='flex justify-center items-center py-12'>
                        ...
                        <span className='ml-3'>Cargando eventos de RDS Oracle...</span>
                    </div>
                ) : eventCount === 0 ? (
