...
interface CalculatedSummaryRdsOracle {
  Last_CPU_Credit_Balance_RDS_Oracle: number;
  Last_CPU_Credit_Usage_RDS_Oracle: number;
  Porcentaje_Uso_Créditos_CPU_RDS_Oracle: number;
  Eficiencia_Creditos_CPU_RDS_Oracle_Instancia: string;
}

interface RdsOracleMetricsData {
  metrics_data: unknown[];
  calculated_summary?: CalculatedSummaryRdsOracle;
}

interface MainRdsOracleResourceViewMetricsSummaryProps {
  data: RdsOracleMetricsData | null;
}

export const MainRdsOracleResourceViewMetricsSummaryComponent = ({
  data,
}: MainRdsOracleResourceViewMetricsSummaryProps) => {
  ...
  const cards = [
    {
      ...
      value: summary.Last_CPU_Credit_Balance_RDS_Oracle,
      icon: Zap,
    ...
    },
    {
      ...
      value: summary.Last_CPU_Credit_Usage_RDS_Oracle,
      icon: Activity,
    ...
    },
    {
      ...
      value: summary.Porcentaje_Uso_Créditos_CPU_RDS_Oracle,
      icon: Percent,
    ...
    },
    {
      ...
      value: summary.Eficiencia_Creditos_CPU_RDS_Oracle_Instancia,
      icon: TrendingUp,
