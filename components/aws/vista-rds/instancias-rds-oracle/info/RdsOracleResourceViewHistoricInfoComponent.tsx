...
interface OracleResourceViewHistoricInfoComponentProps {
    instances: OracleInstanceData[]
}
...
export const RdsOracleResourceViewHistoricInfoComponent = ({ instances }: OracleResourceViewHistoricInfoComponentProps) => {
    const statusColors = {
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="space-y-2 text-sm">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-medium">{instance.Allocated_Storage_RDS_Oracle_Formatted}</span>
                                </div>
                                <div className="flex justify-between">
                                ...
                                <div className='grid grid-cols-1 md:grid-cols-2 gap-2 p-2 rounded-lg transition-colors duration-200 hover:bg-muted/30'>
                                    <div className='flex items-center gap-2'>
                                        ...
                                        <p className='text-lg font-semibold'>{instance.Total_Subnets_RDS_Oracle}</p>
                                    </div>
                                    <div className='flex items-center gap-2'>
