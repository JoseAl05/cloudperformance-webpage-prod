...
interface RdsOracleResourceViewInfoComponentProps {
    data: OracleInstanceData[] | null;
}
...
export const RdsOracleResourceViewInfoComponent = ({ data }: RdsOracleResourceViewInfoComponentProps) => {
    const statusColors = {
    ...
    const groupedInstances = data.reduce(
        ...
        {} as Record<string, OracleInstanceData[]>,
    )
                                ...
                                <CardContent className='space-y-4'>
                                    ...
                                    <div className='space-y-2 text-sm'>
                                        ...
                                        <div className='flex justify-between'>
                                            ...
                                            <span className='font-medium'>{latestInstance.Allocated_Storage_RDS_Oracle_Formatted}</span>
                                        </div>
                                        <div className='flex justify-between'>
                                        ...
                                        <div className='grid grid-cols-1 md:grid-cols-2 gap-2 p-2 rounded-lg transition-colors duration-200 hover:bg-muted/30'>
                                            <div className='flex items-center gap-2'>
                                                ...
                                                <p className='text-lg font-semibold'>{latestInstance.Total_Subnets_RDS_Oracle}</p>
                                            </div>
                                            <div className='flex items-center gap-2'>
                                                ...
                                                <Dialog key={index}>
                                                    ...
                                                    <DialogContent className='max-w-2xl max-h-[80vh] sm:max-w-4xl'>
                                                        <DialogHeader>
                                                            ...
                                                            <DialogDescription>Información histórica de la instancia Oracle</DialogDescription>
                                                        </DialogHeader>
                                                        <RdsOracleResourceViewHistoricInfoComponent instances={instances} />
                                                    </DialogContent>
                                                </Dialog>
                                            ))}
                                        </div>
