...
interface CalculatedSummaryRds {
  Last_CPU_Credit_Balance_RDS_Mysql: number;
  Last_CPU_Credit_Usage_RDS_Mysql: number;
  Porcentaje_Uso_Créditos_CPU_RDS_Mysql: number;
  Eficiencia_Creditos_CPU_RDS_Mysql_Instancia: string;
}
...
interface MainRdsMysqlResourceViewMetricsSummaryProps {
  data: RdsMetricsData | null;
}

export const MainRdsMysqlResourceViewMetricsSummaryComponent = ({
  data,
}: MainRdsMysqlResourceViewMetricsSummaryProps) => {
  ...
  const cards = [
    {
      ...
      value: summary.Last_CPU_Credit_Balance_RDS_Mysql,
      icon: Zap,
    ...
    },
    {
      ...
      value: summary.Last_CPU_Credit_Usage_RDS_Mysql,
      icon: Activity,
    ...
    },
    {
      ...
      value: summary.Porcentaje_Uso_Créditos_CPU_RDS_Mysql,
      icon: Percent,
    ...
    },
    {
      ...
      value: summary.Eficiencia_Creditos_CPU_RDS_Mysql_Instancia,
      icon: TrendingUp,
