...
interface RdsDbConnectionsChartProps {
    data: MetricPoint[];
    title?: string;
    height?: string;
}

export const RdsDbConnectionsChart = ({
    data,
    title = "Conexiones a Base de Datos",
    height = "300px"
}: RdsDbConnectionsChartProps) => {
    ...
    useEffect(() => {
        ...
        const connectionValues = sortedData.map(item => Number(item.Value.toFixed(0)));
        ...
        const avgConnections = Number((connectionValues.reduce((a, b) => a + b, 0) / connectionValues.length).toFixed(1));
        ...
        const option: echarts.EChartsOption = {
            ...
            <div style="padding: 8px;">
              ...
              <div style="display: flex; align-items: center; gap: 8px;">
                ${param.marker}
                <span>Conexiones Activas: <strong>${param.value}</strong></span>
              </div>
        ...
        return (
            <div className="flex justify-center items-center h-96 bg-gradient-to-br from-orange-50 to-amber-100 rounded-lg border-2 border-dashed border-orange-300">
                <div className="text-center">
                    ...
                    <p className="text-orange-600 font-medium">No hay datos de conexiones disponibles</p>
                    <p className="text-orange-400 text-sm mt-1">Verifica el rango de fechas seleccionado</p>
                </div>
            </div>
        );
    }
