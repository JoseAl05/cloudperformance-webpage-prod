...
import { rdsMysqlEventColumns } from './RdsMySQLEventsColumns';
...
export const RdsMysqlEventsTableComponent = ({
    data,
    startDate,
    endDate,
    instance,
    isLoading = false
}: RdsMysqlEventsTableComponentProps) => {
    const eventsColumns = createColumns(rdsMysqlEventColumns);
                ...
                <div className='flex flex-col md:flex-row justify-between items-start md:items-center gap-4'>
                    <div>
                        <CardTitle className='flex items-center gap-2'>
                            ...
                            Historial de Eventos RDS MySQL
                        </CardTitle>
            ...
            <CardContent>
                {isLoading ? (
                    <div className='flex justify-center items-center py-12'>
                        ...
                        <span className='ml-3'>Cargando eventos de RDS MySQL...</span>
                    </div>
                ) : eventCount === 0 ? (
