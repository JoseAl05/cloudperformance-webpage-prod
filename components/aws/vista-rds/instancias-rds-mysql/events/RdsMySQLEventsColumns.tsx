...
import { Eye, Copy, ExternalLink, FileText, Database } from 'lucide-react'
...
const RdsMysqlEventDetailsModal = ({ event }: { event: RdsMysqlEvent }) => {
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className='max-w-4xl'>
                <DialogHeader>
                    ...
                    <DialogDescription>Información completa sobre el evento de RDS MySQL</DialogDescription>
                </DialogHeader>
                                ...
                                <div className='grid grid-cols-2 gap-4'>
                                    {event.DBInstanceIdentifier && (
                                        <div className='space-y-2'>
                                            ...
                                            <div className='flex items-center gap-2'>
                                                <code className='flex-1 p-2 bg-orange-50 rounded text-sm'>{event.DBInstanceIdentifier}</code>
...
export const rdsMysqlEventColumns: ColumnDef<RdsMysqlEvent>[] = [
    {
    ...
    },
    {
        ...
        cell: ({ getValue }) => (
            <Badge variant='secondary' className='font-mono bg-orange-100 text-orange-700'>
                {String(getValue() || '')}
            </Badge>
        ),
    },
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            // ... resto del código de acciones usando row.original
        },
    },
]