...
interface MysqlInstanceData {
    ...
    Total_Subnets_RDS_Mysql: number;
    EnginePlusVersion: string;
    Allocated_Storage_RDS_Mysql_Formatted: string;
}

interface RdsMysqlResourceViewInfoComponentProps {
    data: MysqlInstanceData[] | null;
}
...
export const RdsMysqlResourceViewInfoComponent = ({ data }: RdsMysqlResourceViewInfoComponentProps) => {
    const statusColors = {
    ...
    const groupedInstances = data.reduce(
        ...
        {} as Record<string, MysqlInstanceData[]>,
    )
        ...
        <div className='w-full xl:w-[22rem]'>
            <div className='space-y-8'>
                {Object.entries(groupedInstances).map(([instanceId, instances]) => {
                    // Obtener la instancia más reciente
                                ...
                                <CardContent className='space-y-4'>
                                    ...
                                    <div className='space-y-2 text-sm'>
                                        ...
                                        <div className='flex justify-between'>
                                            ...
                                            <span className='font-medium'>{latestInstance.Allocated_Storage_RDS_Mysql_Formatted}</span>
                                        </div>
                                        <div className='flex justify-between'>
                                        ...
                                        <div className='grid grid-cols-1 md:grid-cols-2 gap-2 p-2 rounded-lg transition-colors duration-200 hover:bg-muted/30'>
                                            <div className='flex items-center gap-2'>
                                                ...
                                                <p className='text-lg font-semibold'>{latestInstance.Total_Subnets_RDS_Mysql}</p>
                                            </div>
                                            <div className='flex items-center gap-2'>
                                    ...
                                    {/* Botón Ver Historial - AL FINAL como EC2 */}
                                                ...
                                                <Dialog key={index}>
                                                    ...
                                                    <DialogContent className='max-w-2xl max-h-[80vh] sm:max-w-4xl'>
                                                        <DialogHeader>
                                                            ...
                                                            <DialogDescription>Información histórica de la instancia MySQL</DialogDescription>
                                                        </DialogHeader>
                                                        <RdsMysqlResourceViewHistoricInfoComponent instances={instances} />
                                                    </DialogContent>
                                                </Dialog>
                                            ))}
                                        </div>
