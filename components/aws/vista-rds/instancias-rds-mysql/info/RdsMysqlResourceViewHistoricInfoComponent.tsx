...
interface MysqlResourceViewHistoricInfoComponentProps {
...
export const RdsMysqlResourceViewHistoricInfoComponent = ({ instances }: RdsMysqlResourceViewHistoricInfoComponentProps) => {
    const statusColors = {
    ...
    // Ordenar instancias por fecha de observación (más reciente primero)
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="space-y-2 text-sm">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-medium">{instance.Allocated_Storage_RDS_Mysql_Formatted}</span>
                                </div>
                                <div className="flex justify-between">
                                ...
                                <div className='grid grid-cols-1 md:grid-cols-2 gap-2 p-2 rounded-lg transition-colors duration-200 hover:bg-muted/30'>
                                    <div className='flex items-center gap-2'>
                                        ...
                                        <p className='text-lg font-semibold'>{instance.Total_Subnets_RDS_Mysql}</p>
                                    </div>
                                    <div className='flex items-center gap-2'>
