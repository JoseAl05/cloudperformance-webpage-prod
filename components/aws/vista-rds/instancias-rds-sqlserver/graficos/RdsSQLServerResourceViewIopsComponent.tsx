...
export const RdsIopsChart = ({
    ...
    useEffect(() => {
        ...
        const series = Object.keys(grouped).map((label, index) => {
            // Colores específicos para IOPS (tema SQL Server)
            const colorMap: Record<string, { color: string; icon: string }> = {
                "Lecturas por Segundo (Promedio)": { color: '#3b82f6', icon: '📖' }, // azul para lectura
                "Escrituras por Segundo (Promedio)": { color: '#1d4ed8', icon: '✍️' } // azul más oscuro para escritura
            };
        ...
        const option: echarts.EChartsOption = {
            ...
            tooltip: {
                ...
                formatter: function (params: unknown) {
                    ...
                    result += `<div style="font-weight: bold; margin-bottom: 6px; color: #3b82f6;">⚡ ${params[0].axisValue}</div>`;
        ...
        return (
            <div className="flex justify-center items-center h-96 bg-gradient-to-br from-blue-50 to-indigo-100 rounded-lg border-2 border-dashed border-blue-300">
                <div className="text-center">
                    ...
                    <p className="text-blue-600 font-medium">No hay datos de IOPS disponibles</p>
