...
interface RdsMemoryChartProps {
  data: MetricPoint[];
  title?: string;
  height?: string;
}

export const RdsMemoryChart = ({ 
  data, 
  ...
  useEffect(() => {
    ...
    const normalizedValues = memoryValues.map(val => val / unitDivisor);
    ...
    return (
      <div className="flex justify-center items-center h-96 bg-gradient-to-br from-blue-50 to-indigo-100 rounded-lg border-2 border-dashed border-blue-300">
        <div className="text-center">
          ...
          <p className="text-blue-600 font-medium">No hay datos de memoria disponibles</p>
