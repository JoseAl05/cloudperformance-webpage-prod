...
interface RdsStorageChartProps {
    data: MetricPoint[];
    title?: string;
    height?: string;
}

export const RdsStorageChart = ({
    data,
    title = "Storage Disponible",
    height = "300px"
}: RdsStorageChartProps) => {
    ...
    useEffect(() => {
        ...
        const storageValuesGB = storageValues.map(val => bytesToGB(val));
        ...
        const displayValues = shouldUseTB
            ? storageValues.map(val => Number((val / (1024 * 1024 * 1024 * 1024)).toFixed(3)))
            : storageValuesGB;
        ...
        const option: echarts.EChartsOption = {
            ...
            <div style="padding: 10px;">
              <div style="font-weight: bold; margin-bottom: 6px; color: #3b82f6;">
                💾 ${param.axisValue}
              </div>
              ...
              <div style="background: linear-gradient(90deg, #3b82f620, #1d4ed820); padding: 6px; border-radius: 4px; margin: 6px 0;">
            ...
            series: [
                {
                    ...
                    lineStyle: {
                        ...
                        color: {
                            ...
                            colorStops: [
                                ...
                                { offset: 0.3, color: '#1d4ed8' },
                                { offset: 0.7, color: '#1e40af' },
                    ...
                    areaStyle: {
                        ...
                        color: {
                            ...
                            colorStops: [
                                { offset: 0, color: '#3b82f6' },
                                { offset: 0.5, color: 'rgba(59, 130, 246, 0.4)' },
                    ...
                    markLine: {
                        ...
                        label: {
                            ...
                            formatter: (params: unknown) => {
                                const avgDisplay = shouldUseTB
                                    ? Number((avgStorage / (1024 * 1024 * 1024 * 1024)).toFixed(3))
                                    : bytesToGB(avgStorage);
        ...
        return (
            <div className="flex justify-center items-center h-96 bg-gradient-to-br from-blue-50 to-indigo-100 rounded-lg border-2 border-dashed border-blue-300">
                <div className="text-center">
                    ...
                    <p className="text-blue-600 font-medium">No hay datos de almacenamiento disponibles</p>
                    <p className="text-blue-500 text-sm mt-1">Verifica el rango de fechas seleccionado</p>
                </div>
            </div>
        );
    }
