...
interface CalculatedSummaryRds {
  Last_CPU_Credit_Balance_RDS_Sqlserver: number;
  Last_CPU_Credit_Usage_RDS_Sqlserver: number;
  Porcentaje_Uso_Créditos_CPU_RDS_Sqlserver: number;
  Eficiencia_Creditos_CPU_RDS_Sqlserver_Instancia: string;
}

interface RdsMetricsData {
  metrics_data: unknown[];
  calculated_summary?: CalculatedSummaryRds;
}

interface MainRdsSQLServerResourceViewMetricsSummaryProps {
  data: RdsMetricsData | null;
}

export const MainRdsSQLServerResourceViewMetricsSummaryComponent = ({
  data,
}: MainRdsSQLServerResourceViewMetricsSummaryProps) => {
  ...
  const cards = [
    {
      ...
      value: summary.Last_CPU_Credit_Balance_RDS_Sqlserver,
      icon: Zap,
    ...
    },
    {
      ...
      value: summary.Last_CPU_Credit_Usage_RDS_Sqlserver,
      icon: Activity,
    ...
    },
    {
      ...
      value: summary.Porcentaje_Uso_Créditos_CPU_RDS_Sqlserver,
      icon: Percent,
    ...
    },
    {
      ...
      value: summary.Eficiencia_Creditos_CPU_RDS_Sqlserver_Instancia,
      icon: TrendingUp,
