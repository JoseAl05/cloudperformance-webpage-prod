...
interface RdsSQLServerEventsTableComponentProps {
    data?: unknown;
    startDate: Date;
    endDate: Date;
    instance: string;
...
export const RdsSQLServerEventsTableComponent = ({
    data,
    startDate,
    endDate,
    instance,
    isLoading = false
}: RdsSQLServerEventsTableComponentProps) => {
    const eventsColumns = createColumns(rdsSQLServerEventColumns);
                ...
                <div className='flex flex-col md:flex-row justify-between items-start md:items-center gap-4'>
                    <div>
                        <CardTitle className='flex items-center gap-2'>
                            ...
                            Historial de Eventos RDS SQL Server
                        </CardTitle>
            ...
            <CardContent>
                {isLoading ? (
                    <div className='flex justify-center items-center py-12'>
                        ...
                        <span className='ml-3'>Cargando eventos de RDS SQL Server...</span>
                    </div>
                ) : eventCount === 0 ? (
