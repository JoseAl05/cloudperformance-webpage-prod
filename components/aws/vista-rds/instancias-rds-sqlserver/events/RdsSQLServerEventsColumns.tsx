...
const RdsSQLServerEventDetailsModal = ({ event }: { event: RdsSQLServerEvent }) => {
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className='max-w-4xl'>
                <DialogHeader>
                    ...
                    <DialogDescription>Información completa sobre el evento de RDS SQL Server</DialogDescription>
                </DialogHeader>
                                ...
                                <div className='grid grid-cols-2 gap-4'>
                                    {event.DBInstanceIdentifier && (
                                        <div className='space-y-2'>
                                            ...
                                            <div className='flex items-center gap-2'>
                                                <code className='flex-1 p-2 bg-blue-50 rounded text-sm'>{event.DBInstanceIdentifier}</code>
                        ...
                        <div className='space-y-2'>
                            ...
                            <div className='space-y-2'>
                                {(event.Resources_ResourceName || []).map((name, index) => (
                                    <div key={index} className='flex items-center justify-between p-3 rounded-lg border bg-blue-50/50'>
...
const RdsResourcesCell = ({ resourceNames, resourceTypes }: { resourceNames: string[]; resourceTypes: string[] }) => {
    ...
    return (
        <div className='space-y-1'>
            ...
            <div className='text-xs text-muted-foreground'>
                <code className='bg-blue-50 px-1 py-0.5 rounded text-xs'>{resources[0]?.name || 'No resources'}</code>
...
export const rdsSQLServerEventColumns: ColumnDef<RdsSQLServerEvent>[] = [
    {
    ...
    },
    {
        ...
        cell: ({ getValue }) => (
            <Badge variant='secondary' className='font-mono bg-blue-100 text-blue-700'>
                {String(getValue() || '')}
            </Badge>
        ),
    },
            ...
            return (
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align='end'>
                        ...
                        <RdsSQLServerEventDetailsModal event={row.original} />
                    </DropdownMenuContent>
                </DropdownMenu>
            )
        },
