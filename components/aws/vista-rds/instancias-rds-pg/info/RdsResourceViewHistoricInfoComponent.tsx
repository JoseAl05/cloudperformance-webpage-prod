...
interface RdsResourceViewHistoricInfoComponentProps {
...
export const RdsResourceViewHistoricInfoComponent = ({ instances }: RdsResourceViewHistoricInfoComponentProps) => {
    const statusColors = {
                            ...
                            <div className='space-y-2 text-sm'>
                                ...
                                <div className='grid grid-cols-1 md:grid-cols-2 gap-2 p-2 rounded-lg transition-colors duration-200 hover:bg-muted/30'>
                                    <div className='flex items-center gap-2'>
                                        ...
                                        <p className='text-lg font-semibold'>{instance.Total_Subnets_RDS_Postgresql}</p>
                                    </div>
                                    <div className='flex items-center gap-2'>
