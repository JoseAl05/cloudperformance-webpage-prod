...
interface CalculatedSummaryRds {
  Last_CPU_Credit_Balance_RDS_Postgresql: number;
  Last_CPU_Credit_Usage_RDS_Postgresql: number;
  Porcentaje_Uso_Créditos_CPU_RDS_Postgresql: number;
  Eficiencia_Creditos_CPU_RDS_Postgresql_Instancia: string;
}
...
interface MainRdsPgResourceViewMetricsSummaryProps {
  data: RdsMetricsData | null;
}

export const MainRdsPgResourceViewMetricsSummaryComponent = ({
  data,
}: MainRdsPgResourceViewMetricsSummaryProps) => {
  ...
  const cards = [
    {
      ...
      value: summary.Last_CPU_Credit_Balance_RDS_Postgresql,
      icon: Zap,
    ...
    },
    {
      ...
      value: summary.Last_CPU_Credit_Usage_RDS_Postgresql,
      icon: Activity,
    ...
    },
    {
      ...
      value: summary.Porcentaje_Uso_Créditos_CPU_RDS_Postgresql,
      icon: Percent,
    ...
    },
    {
      ...
      value: summary.Eficiencia_Creditos_CPU_RDS_Postgresql_Instancia,
      icon: TrendingUp,
