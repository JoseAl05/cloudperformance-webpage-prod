        ...
        const option: echarts.EChartsOption = {
            ...
            tooltip: {
                ...
                formatter: function (params: unknown) {
                    ...
                    result += `<div style="font-weight: bold; margin-bottom: 6px; color: #6366f1;">⚡ ${params[0].axisValue}</div>`;
