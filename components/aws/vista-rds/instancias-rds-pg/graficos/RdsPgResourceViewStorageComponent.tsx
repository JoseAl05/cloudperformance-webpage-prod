    ...
    useEffect(() => {
        ...
        const option: echarts.EChartsOption = {
            ...
            <div style="padding: 10px;">
              <div style="font-weight: bold; margin-bottom: 6px; color: #7c3aed;">
                💾 ${param.axisValue}
              </div>
              ...
              <div style="background: linear-gradient(90deg, #7c3aed20, #a855f720); padding: 6px; border-radius: 4px; margin: 6px 0;">
            ...
            series: [
                {
                    ...
                    areaStyle: {
                        ...
                        color: {
                            ...
                            colorStops: [
                                { offset: 0, color: '#7c3aed' },
                                { offset: 0.5, color: 'rgba(124, 58, 237, 0.4)' },
