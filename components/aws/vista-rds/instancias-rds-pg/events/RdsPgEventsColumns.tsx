...
const RdsPgEventDetailsModal = ({ event }: { event: RdsPgEvent }) => {
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className='max-w-4xl'>
                <DialogHeader>
                    ...
                    <DialogDescription>Información completa sobre el evento de RDS PostgreSQL</DialogDescription>
                </DialogHeader>
                <ScrollArea className='max-h-[60vh]'>
                    <div className='space-y-4'>
                        <div className='grid grid-cols-2 gap-4'>
                            ...
                            <div className='space-y-2'>
                                <label className='text-sm font-medium'>Fecha de ObservaciÃ³n</label>
                                <div className='flex items-center gap-2'>
                        ...
                        {/* InformaciÃ³n especÃ­fica de RDS */}
                                ...
                                <div className='grid grid-cols-2 gap-4'>
                                    {event.DBInstanceIdentifier && (
                                        <div className='space-y-2'>
                                            ...
                                            <div className='flex items-center gap-2'>
                                                <code className='flex-1 p-2 bg-purple-50 rounded text-sm'>{event.DBInstanceIdentifier}</code>
                        ...
                        <div className='space-y-2'>
                            ...
                            <div className='space-y-2'>
                                {(event.Resources_ResourceName || []).map((name, index) => (
                                    <div key={index} className='flex items-center justify-between p-3 rounded-lg border bg-purple-50/50'>
...
const RdsResourcesCell = ({ resourceNames, resourceTypes }: { resourceNames: string[]; resourceTypes: string[] }) => {
    ...
    return (
        <div className='space-y-1'>
            ...
            <div className='text-xs text-muted-foreground'>
                <code className='bg-purple-50 px-1 py-0.5 rounded text-xs'>{resources[0]?.name || 'No resources'}</code>
                {resources.length > 1 && <span className='ml-1'>+{resources.length - 1} mÃ¡s</span>}
            </div>
        </div>
    )
}

export const rdsPgEventColumns: ColumnDef<RdsPgEvent>[] = [
    {
    ...
    },
    {
        ...
        cell: (value, row) => (
            <div className='flex items-center gap-2'>
                ...
                <div className='font-mono text-sm text-muted-foreground'>{String(value)}</div>
            </div>
        ),
    },
    {
            ...
            return (
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align='end'>
                        ...
                        <RdsPgEventDetailsModal event={row} />
                    </DropdownMenuContent>
                </DropdownMenu>
            )
        },
