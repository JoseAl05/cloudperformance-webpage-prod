...
import { rdsMariaDBEventColumns } from './RdsMariaDBEventsColumns';
...
export const RdsMariaDBEventsTableComponent = ({
    data,
    startDate,
    endDate,
    instance,
    isLoading = false
}: RdsMariaDBEventsTableComponentProps) => {
    const eventsColumns = createColumns(rdsMariaDBEventColumns);
                ...
                <div className='flex flex-col md:flex-row justify-between items-start md:items-center gap-4'>
                    <div>
                        <CardTitle className='flex items-center gap-2'>
                            ...
                            Historial de Eventos RDS MariaDB
                        </CardTitle>
            ...
            <CardContent>
                {isLoading ? (
                    <div className='flex justify-center items-center py-12'>
                        ...
                        <span className='ml-3'>Cargando eventos de RDS MariaDB...</span>
                    </div>
                ) : eventCount === 0 ? (
