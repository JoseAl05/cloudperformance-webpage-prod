...
interface RdsMariaDBStorageChartProps {
    data: MetricPoint[];
    title?: string;
    height?: string;
}

export const RdsMariaDBStorageChart = ({
    data,
    title = "Storage Disponible",
    height = "300px"
}: RdsMariaDBStorageChartProps) => {
    ...
    useEffect(() => {
        ...
        const option: echarts.EChartsOption = {
            ...
            <div style="padding: 10px;">
              <div style="font-weight: bold; margin-bottom: 6px; color: #f59e0b;">
              ...
              <div style="background: linear-gradient(90deg, #f59e0b20, #d97706c20); padding: 6px; border-radius: 4px; margin: 6px 0;">
            ...
            series: [
                {
                    ...
                    lineStyle: {
                        ...
                        color: {
                            ...
                            colorStops: [
                                ...
                                { offset: 0.3, color: '#d97706' },
                                { offset: 0.7, color: '#b45309' },
                    ...
                    areaStyle: {
                        ...
                        color: {
                            ...
                            colorStops: [
                                { offset: 0, color: '#f59e0b' },
                                { offset: 0.5, color: 'rgba(245, 158, 11, 0.4)' },
        ...
        return (
            <div className="flex justify-center items-center h-96 bg-gradient-to-br from-amber-50 to-yellow-100 rounded-lg border-2 border-dashed border-amber-300">
                <div className="text-center">
                    ...
                    <p className="text-amber-600 font-medium">No hay datos de almacenamiento disponibles</p>
