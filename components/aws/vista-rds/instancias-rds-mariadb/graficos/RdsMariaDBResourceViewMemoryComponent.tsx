...
interface RdsMariaDBMemoryChartProps {
  data: MetricPoint[];
  title?: string;
  height?: string;
}

export const RdsMariaDBMemoryChart = ({ 
  data, 
  title = "Memoria Disponible",
  height = "300px"
}: RdsMariaDBMemoryChartProps) => {
          ...
          markLine: {
            ...
            label: {
              ...
              formatter: (params: unknown) => {
                const avgDisplay = Number((avgMemory / unitDivisor).toFixed(1));
                return `Promedio: ${avgDisplay} ${avgFormatted.unit}`;
              },
              fontSize: 10,
              color: '#f59e0b'
            },
    ...
    return (
      <div className="flex justify-center items-center h-96 bg-gradient-to-br from-amber-50 to-yellow-100 rounded-lg border-2 border-dashed border-amber-300">
        <div className="text-center">
          ...
          <p className="text-amber-600 font-medium">No hay datos de memoria disponibles</p>
