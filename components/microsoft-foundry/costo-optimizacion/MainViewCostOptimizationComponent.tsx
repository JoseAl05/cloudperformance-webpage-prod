...
export const MainViewCostOptimizationFoundryComponent = () => {
    ...
    const modules = [
        ...
        //     href: '/microsoft-foundry/costo-optimizacion/inference-profiles',
        //     icon: User,
        ...
        //     href: '/microsoft-foundry/costo-optimizacion/custom-models',
        //     icon: Map,
