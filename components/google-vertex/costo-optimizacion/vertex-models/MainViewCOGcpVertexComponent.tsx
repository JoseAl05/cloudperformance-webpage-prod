...
import { GcpVertexComponent } from './COGcpVertexComponent'

export const MainViewGcpVertexComponent = () => {
  return (
            ...
            <div className='flex items-center gap-3 mb-2'>
              ...
              <div>
                <h1 className='text-3xl font-bold text-gray-900 dark:text-gray-100'>
                  Costo y Optimizacion Google Vertex AI
                </h1>
              </div>
            </div>
          </div>
