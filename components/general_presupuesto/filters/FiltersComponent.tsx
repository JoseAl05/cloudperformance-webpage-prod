...
import { Calendar, Filter, MapPin, Server, Tag, XCircle, Ban, Box, Activity, BarChart3, Cloud } from 'lucide-react';
...
export const FiltersComponent = ({
    ...
    const handleTagChange = (nextKey: string | null, nextValue: string | null) => {
        ...
        if (tempCloud && tempCloud !== 'all_clouds') {
            params.set('cloud', tempCloud);
        } else {
            params.delete('cloud');
        }
