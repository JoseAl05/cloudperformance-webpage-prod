...
import { AzureVmHistoricInfoComponent, AzureInstance, VmStatus, VmDisk, VmNic } from './AzureNodeHistoricInfoComponent';
...
export const AzureNodeInfoComponent = ({ data }: { data: AzureNodeData[] | null }) => {
