...
const AzureMetricsChart = ({ data, title, metricUnit }: AzureMetricsChartProps) => {
...
export const AzureCpuUsageComponent = ({ data }: { data: AzureMetricsData[] | null }) => (
  <AzureMetricsChart data={data} title="Uso de Cores de CPU" metricUnit="vCores" />
);

export const AzureMemoryUsageComponent = ({ data }: { data: AzureMetricsData[] | null }) => (
  <AzureMetricsChart data={data} title="Uso de Memoria" metricUnit="GB" />
);

export const AzureStorageUsageComponent = ({ data }: { data: AzureMetricsData[] | null }) => (
  <AzureMetricsChart data={data} title="Uso de IOPS de Almacenamiento" metricUnit="IOPS" />
);