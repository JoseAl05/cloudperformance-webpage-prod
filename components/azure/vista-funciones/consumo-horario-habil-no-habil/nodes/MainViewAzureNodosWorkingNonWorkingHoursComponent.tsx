...
import { AzureNodosWorkingNonWorkingHoursComponent } from './AzureNodosWorkingNonWorkingHoursComponent';

export const MainViewAzureNodosWorkingNonWorkingHoursComponent = () => {
    return (
        <div className='w-full min-w-0 space-y-4'>
                        ...
                        <div className='flex items-center gap-3 mb-2'>
                            ...
                            <div>
                                <h1 className='text-3xl font-bold text-gray-900 dark:text-gray-100'>
                                    Análisis uso de Nodos AKS Azure en horario hábil y no hábil
                                </h1>
                            </div>
                        </div>
                    </div>
            ...
            <div className='w-full min-w-0'>
                <FiltersComponent
                    Component={AzureNodosWorkingNonWorkingHoursComponent}
                    dateFilter
                    regionFilter
                    isRegionMultiSelect
                    subscriptionIdFilter
                    tagsFilter
                    tagsCollection="custom_vmss_uniform_k8s_nodes_metrics_logs"
                    tagsColumnName="tags"
