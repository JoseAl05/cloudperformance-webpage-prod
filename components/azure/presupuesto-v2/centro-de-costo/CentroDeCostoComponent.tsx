...
import { CentroDeCostoTableComponent, CentroCosto } from "@/components/azure/presupuesto-v2/centro-de-costo/table/CentroDeCostoTableComponent";
import { CentroDeCostoFormComponent } from "@/components/azure/presupuesto-v2/centro-de-costo/form/CentroDeCostoFormComponent";
...
export const CentroDeCostoComponent = () => {
  ...
  const handleScanCloud = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/presupuesto/bridge/${cloudType}/azure/obtener-centro-costo?${params.toString()}`
      );
  ...
  const handleImportSubmit = async () => {
    ...
    try {
      const response = await fetch(
        `/api/${cloudType}/azure/centro-costo/importar-masivo`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
