...
import { CostosVsPresupuestoComponentAzure } from "./CostosVsPresupuestoComponent";

export const MainViewCostoVsPresupuestoAzure = () => {
  return (
    <SessionGate>
      <div className="w-full min-w-0 space-y-4">
        ...
        <div className="w-full min-w-0">
          <FiltersComponent
            Component={CostosVsPresupuestoComponentAzure}
            dateFilter={false}
            anioFilter 
