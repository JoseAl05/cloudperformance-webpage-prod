...
export interface AzureMysqlData {
...
interface Props {
    data: AzureMysqlData[] | null;
}

export const AzureMysqlInfoComponent = ({ data }: Props) => {
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm font-semibold text-gray-900 dark:text-gray-100">
                                {latestHistory.state} • MySQL {latestHistory.version}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm font-semibold text-gray-900 dark:text-gray-100">
                                {latestHistory.storage?.storage_size_gb} GB
                            </p>
                        </div>
                    </div>
