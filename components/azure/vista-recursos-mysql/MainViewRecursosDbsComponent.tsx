...
import { AzureMysqlResourceComponent } from './AzureMysqlResourceComponent';

export const MainViewRecursosMysqlComponent = () => {
    return (
        <div className='w-full min-w-0 space-y-4'>
                        ...
                        <div className='flex items-center gap-3 mb-2'>
                            ...
                            <div>
                                <h1 className='text-3xl font-bold text-gray-900 dark:text-gray-100'>
                                    Detalles de Base de Datos (MySQL)
                                </h1>
                            </div>
                        </div>
                    </div>
            ...
            <div className='w-full min-w-0'>
                <FiltersComponent
                    Component={AzureMysqlResourceComponent}
                    dateFilter
                    ...
                    instancesFilterV2
                    instancesV2Collection="azure_mysqlflexibleservers_servers"
