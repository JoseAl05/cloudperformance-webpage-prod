import { CloudSqlComponent } from '@/components/gcp/vista-recursos/cloudsql/CloudSqlComponent'
import { FiltersComponent } from '@/components/general_gcp/filters/FiltersComponent'
import { PieChart } from 'lucide-react'

export const MainViewCloudSqlComponent = ({ db_engine }: { db_engine: string }) => {
    return (
                        ...
                        <div className='flex items-center gap-3 mb-2'>
                            ...
                            <div>
                                <h1 className='text-3xl font-bold text-gray-900 dark:text-gray-100'>
                                    Instancias CloudSQL - {db_engine.toUpperCase()}
                                </h1>
                            </div>
                        </div>
                    </div>
