...
import { ComputeEngineBillingTable } from '@/components/gcp/vista-recursos/compute-engine/table/ComputeEngineBillingTableComponent';
...
export const CloudSqlComponent = ({
    ...
    const cSqlMetrics = useSWR(
        resourceId ? `/api/gcp/bridge/gcp/instancias_cloud_sql/gcp-cloudsql-instances_metrics?date_from=${startDateFormatted}&date_to=${endDateFormatted}&instance=${resourceId}` : null,
        fetcher
    )

    const cSqlInfo = useSWR(
        resourceId ? `/api/gcp/bridge/gcp/instancias_cloud_sql/gcp-cloudsql-instances?date_from=${startDateFormatted}&date_to=${endDateFormatted}&instance=${resourceId}` : null,
        fetcher
    )

    const cSqlBilling = useSWR(
        resourceId ? `/api/gcp/bridge/gcp/instancias_cloud_sql/gcp-cloudsql-instances_billing?date_from=${startDateFormatted}&date_to=${endDateFormatted}&instance=${resourceId}` : null,
        fetcher
    )
