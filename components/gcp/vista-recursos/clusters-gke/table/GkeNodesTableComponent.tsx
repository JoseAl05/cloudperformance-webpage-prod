...
import { getGkeNodesColumns, ProcessedInstanceRow } from '@/components/gcp/vista-recursos/clusters-gke/table/GkeNodesColumns';

interface GkeNodesTableComponentProps {
    data: ClusterGkeInstances[];
}
...
export const GkeNodesTableComponent = ({ data }: GkeNodesTableComponentProps) => {
    const [selectedInstance, setSelectedInstance] = useState<ClusterGkeInstances | null>(null);
    ...
    const columns = useMemo(() =>
        createColumns(getGkeNodesColumns(handleHistoryClick)),
        []);
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground mt-1">
                                Nodos generados por instance group en el cluster y periodo seleccionado.
                            </p>
                        </div>
