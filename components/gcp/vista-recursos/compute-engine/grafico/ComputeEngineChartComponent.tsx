...
interface ComputeEngineChartComponentProps {
    data: ComputeEngineMetrics[];
}

const SingleMetricChart = ({ metric }: { metric: ComputeEngineMetrics }) => {
...
export const ComputeEngineChartComponent = ({ data }: ComputeEngineChartComponentProps) => {
