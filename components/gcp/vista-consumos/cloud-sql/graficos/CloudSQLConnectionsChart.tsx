...
interface ConnectionsDataPoint {
    date: string;
...
interface CloudSQLConnectionsChartProps {
    data: ConnectionsDataPoint[] | null;
}

export const CloudSQLConnectionsChart = ({ data }: CloudSQLConnectionsChartProps) => {
                ...
                {isEmpty ? (
                    <div className="w-full h-[200px] flex items-center justify-center">
                        <p className="text-sm text-muted-foreground">
                            No hay métricas de conexiones disponibles.
                        </p>
                    </div>
                ) : (
