...
interface CloudSQLStorageChartProps {
    data: StorageDataPoint[] | null;
}

export const CloudSQLStorageChart = ({ data }: CloudSQLStorageChartProps) => {
    ...
    return (
        <Card className="w-full">
            <CardHeader>
                <CardTitle>Utilización de Storage</CardTitle>
            </CardHeader>
            <CardContent>
