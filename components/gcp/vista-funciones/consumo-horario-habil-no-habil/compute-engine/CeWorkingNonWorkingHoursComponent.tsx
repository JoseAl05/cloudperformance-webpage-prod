...
interface CeWorkingNonWorkingHoursComponentProps {
    startDate: Date;
    endDate: Date;
    resourceId: string;
    regions: string;
...
export const CeWorkingNonWorkingHoursComponent = ({ startDate, endDate, regions, projects, resourceId }: CeWorkingNonWorkingHoursComponentProps) => {
