...
interface TopFilestoreSubUtilizadoSinMetricasTableProps {
    data: SinMetricasItem[];
}

export const TopFilestoreSubUtilizadoSinMetricasTable = ({
    data,
}: TopFilestoreSubUtilizadoSinMetricasTableProps) => {
