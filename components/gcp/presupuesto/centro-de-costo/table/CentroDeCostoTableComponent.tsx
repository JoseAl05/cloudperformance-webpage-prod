...
export interface CentroCosto {
  ...
  responsable_centro: string | null;
...
const fetcher = async (url: string): Promise<CentroCosto[]> => {
  ...
  const filteredAndSortedData = useMemo(() => {
    ...
    const filtered = centros.filter((centro) => {
      ...
      return (
        ...
        (centro.responsable_centro && centro.responsable_centro.toLowerCase().includes(search)) ||
        (centro.localizacion && centro.localizacion.toLowerCase().includes(search))
      );
    });
        ...
        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
            {paginatedData.length === 0 ? (
              <tr>
                {/* Cambiado el colSpan de 6 a 5 al eliminar la columna de Tags */}
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-center">
                    <div className="flex items-center justify-center gap-2">
                      ...
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          onDelete(centro.id_centro_costo);
                        }}
