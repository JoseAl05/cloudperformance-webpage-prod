...
import { CostosVsPresupuestoComponentGCP } from "./CostosVsPresupuestoComponent";

export const MainViewCostoVsPresupuestoGCP = () => {
  return (
    <SessionGate>
      <div className="w-full min-w-0 space-y-4">
        ...
        <div className="w-full min-w-0">
          <FiltersComponent
            Component={CostosVsPresupuestoComponentGCP}
            dateFilter={false}
            anioFilter 
            cloudFilterType={"gcp"}
          />
