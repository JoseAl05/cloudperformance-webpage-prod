...
import { MainViewAiRecommendationStatusesComponent } from '@/components/ai-recommendation-statuses/MainViewAiRecommendationStatusesComponent';
...
export default function DashboardAzureRecStatusesPage() {
    const {
        loading,
    ...
    return (
        <div className=''>
            <Suspense fallback={<div>Cargando...</div>}>
                <MainViewAiRecommendationStatusesComponent cloud="azure" />
            </Suspense>
        </div>
    )
}