                    ...
                    <CardContent className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                        <Link href="/aws/recursos/instancias-ec2" className="group">
                            <div className="rounded-xl border p-3 hover:bg-muted transition">
                                ...
                                <div className="text-xs text-muted-foreground">Listado y detalle de instancias</div>
                            </div>
                        </Link>
                        ...
                        <Link href="/aws/recursos/autoscaling-groups" className="group">
                            <div className="rounded-xl border p-3 hover:bg-muted transition">
                                ...
                                <div className="text-xs text-muted-foreground">Capacidad y políticas</div>
                            </div>
                        </Link>
                        ...
                        <Link href="/aws/recursos/instancias-rds-pg" className="group">
                            <div className="rounded-xl border p-3 hover:bg-muted transition">
                                ...
                                <div className="text-xs text-muted-foreground">Instancias y parámetros</div>
                            </div>
                        </Link>
