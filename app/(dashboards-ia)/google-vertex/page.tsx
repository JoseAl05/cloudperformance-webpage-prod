...
export default function DashboardGoogleVertexPage() {
    return (
                ...
                <div className="flex items-start justify-between gap-4">
                    <div className="flex items-start gap-3">
                        <div className="relative h-18 w-18 md:h-20 md:w-20">
                            <Image src="/vertexai.svg" alt="Google Vertex" fill className="object-contain" priority />
                        </div>
                        <div>
                            <h1 className="text-2xl md:text-3xl font-semibold tracking-tight">Dashboard Google Vertex</h1>
            ...
            <div className="space-y-4">
                <section className="rounded-2xl border p-6 bg-gradient-to-br from-slate-50 to-white md:p-8 dark:from-slate-900 dark:to-slate-950">
                    ...
                    <p className="text-sm text-muted-foreground mt-2">
                        Explora todas las funciones y recursos disponibles en tu dashboard Google Vertex.
                    </p>
                </section>
            </div>
        </div>
